...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    DBSession* dbSession = [[DBSession alloc] initWithAppKey:@"7g7ejszzm9cyl2w" appSecret:@"o6vi5q7waniz3vv" root:kDBRootDropbox];//kDBRootAppFolder  kDBRootDropbox
...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification
{
	...
	//[self.remindMeViewController showReminder:reminderText];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ProjMgrDB" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ProjMgrDB.sqlite"];
