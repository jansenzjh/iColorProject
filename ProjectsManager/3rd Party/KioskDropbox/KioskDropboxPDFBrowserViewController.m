...
- (void) listDropboxDirectory {
    ...
    if (![self.dataController isDropboxLinked]) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"warning", nil)
                                                            message:NSLocalizedString(@"msg warn", nil)
                                                           delegate:nil
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *rightButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"done", nil)
...
//    self.navigationItem.rightBarButtonItem = rightButton;
    ...
    [tController setProjName:self.projName];
